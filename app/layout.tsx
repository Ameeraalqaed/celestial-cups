...
export default function Home() {
  ...
  return (
    <main className="relative text-[#ceaaff]">
      ...
      {/* Taller section = more scroll distance per video second = smoother
          full playthrough. 700vh gives ~600vh of travel for ~28s of film. */}
      <section ref={scrubRef} className="relative h-[700vh]">
        <div className="sticky top-0 h-dvh w-full overflow-hidden">
          ...
          {/* Scroll-down cue — centered at the bottom, fades on scroll */}
          <div
            ref={cueRef}
            className="absolute inset-x-0 bottom-10 flex flex-col items-center gap-3 transition-all duration-500"
          >
